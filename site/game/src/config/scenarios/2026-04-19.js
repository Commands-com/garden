const scenario_2026_04_19 = {
  ...
  challenge: {
    ...
    objective:
      "Four scripted waves, 2 HP wall. Pollen Puff is required to clear: at least one wave pairs Thornwings so a single Pollen Puff bolt splashes both. Bramble alone cannot cover every cluster within cadence budget.",
    ...
    waves: [
      {
        ...
        events: [
          ...
          { offsetMs: 11500, lane: 1, enemyId: "shardMite" },
      ...
      },
      {
        ...
        events: [
          ...
          { offsetMs: 9000, lane: 4, enemyId: "shardMite" },
      ...
      },
      {
        ...
        events: [
          ...
          { offsetMs: 11500, lane: 4, enemyId: "thornwingMoth" },
          { offsetMs: 12500, lane: 3, enemyId: "thornwingMoth" },
          { offsetMs: 12500, lane: 4, enemyId: "thornwingMoth" },
          { offsetMs: 14750, lane: 1, enemyId: "glassRam" },
          { offsetMs: 14500, lane: 4, enemyId: "shardMite" },
          { offsetMs: 15000, lane: 3, enemyId: "glassRam" },
          { offsetMs: 15250, lane: 4, enemyId: "glassRam" },
